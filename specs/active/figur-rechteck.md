...
type: code
repo: edvancev1
branch: spec/figur-rechteck
depends_on: []
gates:
  - npm run typecheck
  - npm test -- figur-rechteck
---

## Ziel

Ein parametrischer SVG-Generator für **ein Rechteck oder Quadrat**, nach dem Muster des bestehenden
...
- Generator `rechteck` mit den Parametern: `laenge: number`, `breite: number`, `einheit?: string`, `diagonale?: boolean`
...
- Tests in `tests/figur-rechteck.test.ts`: gültige Parameter, Randwerte, ungültige
